  ...
  players: [
    ...
    },
    {
      ...
      voice: {
        ...
        fear: 'seeing the dead move in formation and recognizing the command behind them before anyone else does',
        desire: 'to finish one last paid duty without becoming the kind of weapon courts keep reaching for',
        contradiction: 'can read a killing order in the set of marching bodies, but fears the part of himself that still wants to answer it',
      },
      backstory: {
        origin: 'Corvin Hale deserted the companies after Mirehill and spent years taking road work that asked for strength, not orders, until a royal writ dragged him back toward formation and command.',
        wound: 'At Mirehill, Corvin watched a captain keep shouting commands after the line was already doomed, and he survived by obeying until obedience felt like another kind of death.',
        want: 'He wants to prove the dead are being directed, break the hand giving orders, and return to a life where no command can make him useful again.',
        privateKnowledge: 'Soldiers reveal their commander in the space between movements; even dead men betray the mind drilling them if you know where to look.',
      },
      memory: ['At Mirehill, Corvin stood knee-deep in thawing mud while the captain’s whistle ordered the left rank forward again, though half the men were already down and the rest knew the hill was lost.'],
    },
  ],
  nodes: [
    {
    ...
    },
    {
      ...
      canonicalDescription: 'The Old Watchtower is a leaning hill tower where bad maps, burial marks, and one stubborn thread of chimney smoke have survived the weather.',
      description: 'A leaning hill tower where bad maps, old burial customs, and one stubborn thread of chimney smoke have survived the weather.',
      explorationHint: 'A high path climbs toward broken stone, old warning marks, and smoke too thin for a hearth that has gone cold.',
      iconAssetId: 'codex',
      nodeType: 'watch',
      exits: [
    ...
    },
    {
      ...
      canonicalDescription: 'The Old Barrow is a buried hall under the hill, cold with old bones, a cracked bell, and a quiet that feels arranged rather than natural.',
      description: 'A buried hall under the hill, cold with old bones, a cracked bell, and a quiet that feels arranged rather than natural.',
  ...
  events: [
    ...
    },
    {
      ...
      choices: [
        ...
        {
          id: 'hold-cellar-door-by-hand',
          label: 'Hold the cellar door yourself',
          neutralSummary: 'You bought the rescue with your own body, keeping the dead back long enough for the cellar to open.',
          writerIntent: 'Offer a no-item fallback with a higher personal cost when the safer consumables are gone.',
          actionPrompt: 'The selected option is to brace the cellar door by hand, take the dead weight against your shoulder, and hold until the people below can scramble clear.',
          mode: 'risk',
          displayStyle: 'action',
          skillTags: ['raw-strength', 'mental-fortitude'],
          effects: [
            { type: 'remember', text: 'The cellar opened because you held the dead back with your own body.' },
            { type: 'moveToNode', nodeId: 'blackpine-road' },
          ],
        },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        {
          id: 'wait-and-read-the-mist',
          label: 'Wait and read the burial mist',
          neutralSummary: 'You held still long enough for the mist to show where the dead had disturbed the road.',
          writerIntent: 'Offer a Tamsin-facing wait option that rewards grave-lore and mental fortitude instead of another physical action.',
          actionPrompt: 'The selected option is to wait in disciplined silence, read how the burial mist gathers around disturbed ground, and move only when the dead drift past.',
          mode: 'wait',
          displayStyle: 'passive',
          skillTags: ['grave-lore', 'mental-fortitude'],
          effects: [
            { type: 'remember', text: 'Waiting showed that the mist clings thickest around disturbed royal dead.' },
            { type: 'moveToNode', nodeId: 'barrow-crypt' },
          ],
        },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        },
        {
          ...
          skillTags: ['grave-lore', 'plain-speech'],
          effects: [
            { type: 'remember', text: 'The court heard its own names placed on the royal dead before anyone could make the cost sound general.' },
            { type: 'setFlag', flag: 'proof-delivered', value: true },
          ],
        },
      ],
